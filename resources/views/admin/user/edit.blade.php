    ...
    <div class="max-w-4xl mx-auto"> 
        ...
        <div class="flex items-center justify-between mb-6">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-xl font-bold text-slate-800 tracking-tight">Edit Akun User</h3>
                    <p class="text-slate-400 text-[9px] font-bold uppercase tracking-widest mt-0.5">Update Akun: {{ $user->nama }}</p>
                </div>
            </div>
        ...
        <div class="bg-white rounded-[1.5rem] border border-slate-200 shadow-xl shadow-slate-200/40 overflow-hidden">
            ...
            <div class="p-8 md:p-10">
                <form method="POST" action="{{ route('admin.user.update', $user->id_user) }}" class="space-y-6">
                    @csrf 
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" name="nama" value="{{ old('nama', $user->nama) }}" required
                                    class="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-semibold text-slate-700 focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-yellow-500/5 transition-all outline-none"
                        ...
                        <div class="space-y-1.5">
                            ...
                            <p class="text-[9px] text-slate-400 ml-1 italic font-medium">*Kosongkan jika tidak ingin mengubah password</p>
                        </div>
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="relative group">
                                ...
                                <select name="role" required 
                                    class="w-full pl-10 pr-10 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold text-slate-700 focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-yellow-500/5 transition-all outline-none appearance-none cursor-pointer">
                    ...
                    <div class="pt-6 border-t border-slate-100 flex flex-col sm:flex-row items-center gap-3">
                        <button type="submit" class="w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-3.5 bg-blue-600 text-white rounded-xl font-black text-[11px] shadow-lg shadow-slate-200 hover:bg-blue-700 hover:-translate-y-0.5 transition-all active:scale-95 uppercase tracking-widest">
